...
public class C1 implements Constructive<PInstance, PSolution> {
    ...
    public PSolution constructSolution(PInstance instance) {
        ...
        while (!cl.isEmpty()) {
            ...
            double gmin = cl.getLast().greedyFunct;
            double gmax = cl.getFirst().greedyFunct;
    ...
    private void calculateGreedyFunction(List<Candidate> cl, PInstance instance, PSolution sol, int adj) {
        ...
        Candidate candidate = new Candidate(adj, instance.getDegreeOfNode(adj), labeledAdj - nonLabeledAdj);
        cl.add(candidate);
    }
